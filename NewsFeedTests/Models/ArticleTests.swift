...
class ArticleTests: XCTestCase {
    ...
    func testDecodingValidArticle() {
        ...
        do {
            ...
            XCTAssertEqual(firstArticle.createdAt, dateFormatter.date(from: "2019-06-04T16:32:00Z")!)
    ...
    func testDecodingInvalidDateJSON() {
        jsonString = getDateErrorJSON()
        jsonData = jsonString.data(using: .utf8)
        var thrownError: Error?
        ...
        XCTAssertTrue(thrownError is Article.DecodingError)
        XCTAssertEqual(thrownError as? Article.DecodingError, .invalidCreatedAtDate)
    }
    ...
    private func getDateErrorJSON() -> String {
        return "{\"articles\":[{\"id\":1300,\"title\":\"Work Makes Us Lonely. BetterUp Is Working on a Solution to Fix That\",\"created_at\":\"2019-06-04\",\"source\":\"Inc.\",\"description\":\"There have never been more theories spun about what produces happier, more productive workers. BetterUp is using some actual science to get to the bottom of it.\",\"favorite\":true,\"hero_image\":\"https://i.kinja-img.com/gawker-media/image/upload/s--swRlLlgJ--/c_scale,dpr_2.0,f_auto,fl_progressive,q_80,w_800/egad24b4d3w3qizatlba.jpg\",\"link\":\"https://www.inc.com/magazine/201906/leigh-buchanan/betterup-labs-workplace-organization-management-culture-happiness-research-best-workplaces-2019.html\"}]}"
    }
